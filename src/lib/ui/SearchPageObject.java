...
/*TEMPLATES METHODS */
    ...
    {
        this.waitForElementAndClick(By.id(SEARCH_CANCEL_BUTTON), "Cannot find snd click search cancel button", 5);
    }
    ...
    {
        String search_result_spath = getResultSearchElement(substring);
        this.waitForElementAndClick(By.xpath(search_result_spath), "Cannot find and click search result with substring" +substring, 10);
    }
