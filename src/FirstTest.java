...
//        for (int i = 1; i <= 6; i++)
    ...
    public void testAmountOfNotEmptySearch()
    {
        ...
        //проверяем, что количество полученных элементов поиска > 0
        Assert.assertTrue(
    ...
    //проверяем, что в поиске нет результатов.
    private void assertElementNotPresent(By by, String error_message)
    {
        int amount_of_elements = getAmountOfElements(by);
        //считаем количество элементов в поиске по переданному xpath
